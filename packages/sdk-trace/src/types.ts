...
/** @deprecated Use {@link BatchSpanProcessorOptions}, which now includes the browser-only options. */
export type BatchSpanProcessorBrowserOptions = BatchSpanProcessorOptions;
